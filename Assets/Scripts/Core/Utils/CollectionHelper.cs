...
using System;
    ...
    {
        //升序排列
        public static List<T> OrderBy<T,TKey>(List<T> array,SelectHandler<T,TKey> handler)
        ...
        //降序排列
        public static List<T> OrderByDescending<T, TKey>(List<T> array, SelectHandler<T, TKey> handler)
        ...
        //查找
        public static T Find<T>(List<T> array, FindHandler<T> handler)
        {
